...
title_h1 =tree.xpath('//h1[@class="main-title"]//span//text()')[0]
title_h2 =tree.xpath('//h2[@class="sub-title"]/text()')
mrp = tree.xpath('//span[@class="money"]/text()')
salling_price = tree.xpath('//span[@class="regular-price"]/span//text()')
discount_par = tree.xpath('//span[@class="perc_price"]//text()')
description = tree.xpath('//div[@class="content-wrapper"]//p//text()')
